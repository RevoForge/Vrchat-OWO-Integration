...
{
    return start + "{\"priority\":" + sensationPriority + "," + sensationNameStart + builtString1 + sepperator + sensationNameStart + builtString2 + end;
}
if (numberOfStrings == 3)
{
    return start + "{\"priority\":" + sensationPriority + "," + sensationNameStart + builtString1 + sepperator + sensationNameStart + builtString2 + sepperator + sensationNameStart + builtString3 + end;
}
if (numberOfStrings == 4)
{
    return start + "{\"priority\":" + sensationPriority + "," + sensationNameStart + builtString1 + sepperator + sensationNameStart + builtString2 + sepperator + sensationNameStart + builtString3 + sepperator + sensationNameStart + builtString4 + end;
}
if (numberOfStrings == 5)
{
    return start + "{\"priority\":" + sensationPriority + "," + sensationNameStart + builtString1 + sepperator + sensationNameStart + builtString2 + sepperator + sensationNameStart + builtString3 + sepperator + sensationNameStart + builtString4 + sepperator + sensationNameStart + builtString5 + end;
}
