...
[Range(1, 100)]
private int intensityPercentage1 = 0;
...
[SerializeField, Tooltip("Intensity percentage for the Sensation event.")]
[Range(1, 100)]
private int intensityPercentage2 = 0;
[SerializeField, Tooltip("Ramp up time. Only 0.1 Increments affect the Vest.")]
[Range(0,2)]
...
{
builtString1 += sepperator + sensationNameStart;
}
}
break; 
}
...
if (i < triggeredMuscleInt)
{
builtString2 += sepperator + sensationNameStart;
}
}
break; 
}
multiString = BuildMultiSensationString(builtString1, builtString2);
Debug.Log(multiString);
builtString1 = ""; builtString2 = "";
triggerMusclesString = new string[] { "", "", "", "", "", "", "", "", "", "" };
        triggeredMuscleInt = 0;
...
private string BuildMultiSensationString(string builtString1, string builtString2)
{
